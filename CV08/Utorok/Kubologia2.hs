...
triNaSebe polohy = [ [k1,k2,k3] | 
            k1 <- polohy,k2 <- polohy,k3 <- polohy, kockySuOK [k1,k2,k3] ]
{-
Main> :set +s
...
styriNaSebe polohy = [ [k1,k2,k3,k4] | 
            k1 <- polohy,k2 <- polohy,k3 <- polohy, k4 <- polohy, kockySuOK [k1,k2,k3,k4] ]

nNaSebe :: Int -> [Kocka] -> [[Kocka]]
nNaSebe 0 polohy = [ [] ]
nNaSebe n polohy = [ k:m | 
                      k <- polohy, m <- nNaSebe (n-1) polohy, 
                      kockySuOK (k:m)
                   ]

nNaSebe' :: Int -> [Kocka] -> [[Kocka]]
nNaSebe' n polohy = filter kockySuOK (kbo polohy n)
